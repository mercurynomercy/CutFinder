...
function makeSettingsPrefs(overrides: Partial<SettingsPrefs> = {}): SettingsPrefs {
  return {
    ...
    transcription_engine: overrides.transcription_engine ?? 'whisper',
    qwen_asr_model: overrides.qwen_asr_model ?? 'mlx-community/Qwen3-ASR-1.7B-8bit',
    qwen_aligner_model: overrides.qwen_aligner_model ?? 'mlx-community/Qwen3-ForcedAligner-0.6B-8bit',
    qwen_max_chunk_s: overrides.qwen_max_chunk_s ?? 60,
