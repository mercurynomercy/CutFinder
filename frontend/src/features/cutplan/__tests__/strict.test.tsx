...
const PLAN = { shots:[{clip_id:1,roll:'a',in_s:0,out_s:12,content:'x',rationale:'y',chapter:'开场',clip_label:'A-0001.mov',thumb_ref:'/api/clips/1/thumbnail',clip_date:'2026-04-25'}], chapters:['开场'], total_s:12, target_min_s:null,target_max_s:null,within_target:true,note:'',markdown:'md' }
...
describe('strict', () => {
  it('restores under StrictMode', async () => {
    ...
    render(<StrictMode><CutplanPage onClose={()=>{}} onOpenSettings={()=>{}} theme="light" onToggleTheme={()=>{}} /></StrictMode>)
