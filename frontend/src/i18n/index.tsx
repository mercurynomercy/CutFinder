...
const en = {
  ...
  'subtitles.refine': 'Text refinement (optional)',
  'subtitles.asrModel': 'OMLX ASR model',
  'subtitles.asrModelHint': 'Use an OMLX ASR model (e.g. Qwen3-ASR) for more accurate text, aligned onto whisper timing.',
  'subtitles.correctModel': 'Correction model',
  'subtitles.correctModelHint': 'Proofread the cue text with an OMLX text model (e.g. Qwen3.6).',
  'subtitles.modelNone': 'None (whisper only)',
  'subtitles.modelNoneCorrect': 'None (no correction)',
  'subtitles.modelsUnavailable': 'OMLX models unavailable — check the server in Settings.',
...
const zh: Record<Key, string> = {
  ...
  'subtitles.refine': '文本优化（可选）',
  'subtitles.asrModel': 'OMLX ASR 模型',
  'subtitles.asrModelHint': '用 OMLX ASR 模型（如 Qwen3-ASR）获得更准确的文本，对齐到 whisper 的时间轴。',
  'subtitles.correctModel': '矫正模型',
  'subtitles.correctModelHint': '用 OMLX 文本模型（如 Qwen3.6）对字幕文本做校对。',
  'subtitles.modelNone': '不使用（仅 whisper）',
  'subtitles.modelNoneCorrect': '不使用（不矫正）',
  'subtitles.modelsUnavailable': 'OMLX 模型不可用 — 请检查设置中的服务器。',
  'subtitles.export': '导出',
