...
const en = {
  ...
  'launcher.cardSettingsDesc': 'Configure the AI model connection, speech engine, processing options',
  ...
  'roughcut.placeholder': 'e.g. Make a 15–20 min vlog from 2026/04/25–2026/05/11 footage, 16:9, narrative + upbeat rhythm',
  'roughcut.send': 'Send',
  ...
  'roughcut.emptyConvo': 'Describe the cut you want — date range (full year-month-day, e.g. 2026/04/25), length, style, rhythm.',
  ...
  'roughcut.generating': 'Generating · step {n}',
  'roughcut.generatingDay': 'Generating · {idx}/{n}',
  'roughcut.generatingSteps': 'Generation process ({n} steps)',
  'roughcut.elapsed': 'Elapsed {time}',
  'roughcut.stepCurrent': 'Current step',
  ...
  'subtitles.changeVideo': 'Change video',
  'subtitles.changeFolder': 'Change folder',
  ...
  'subtitles.readyStatus': 'Ready — will export {formats} format',
...
const zh: Record<Key, string> = {
  ...
  'launcher.cardSettingsDesc': '配置 AI 模型连接、语音引擎、处理选项等',
  ...
  'roughcut.placeholder': '例如：用 2026/04/25–2026/05/11 的素材剪一条 15–20 分钟、叙事/轻快/有节奏的 vlog，16:9',
  'roughcut.send': '发送',
  'roughcut.thinking': '导演正在生成…',
  'roughcut.progressTitle': '生成过程（{n} 步）',
  'roughcut.partialGenerating': '部分日期已生成，其余仍在继续…',
  'roughcut.emptyConvo': '描述你想要的初剪——日期范围（写完整年月日，例如 2026/04/25）、时长、风格、节奏。',
  'roughcut.planTitle': '分镜表',
  'roughcut.noPlan': '还没有分镜表，发送需求来生成。',
  'roughcut.copyMarkdown': '复制为 Markdown',
  'roughcut.copied': '已复制',
  'roughcut.generating': '生成中 · 第 {n} 步',
  'roughcut.generatingDay': '生成中 · {idx}/{n}',
  'roughcut.generatingSteps': '生成过程（{n} 步）',
  'roughcut.elapsed': '已用时 {time}',
  'roughcut.stepCurrent': '当前步骤',
  'roughcut.close': '关闭',
  ...
  'subtitles.changeVideo': '更换视频',
  'subtitles.changeFolder': '更换文件夹',
  'subtitles.video': '视频',
  'subtitles.folder': '输出文件夹',
  'subtitles.noVideo': '尚未选择视频',
  'subtitles.noFolder': '尚未选择文件夹',
  'subtitles.readyStatus': '已就绪 — 将导出 {formats} 格式',
